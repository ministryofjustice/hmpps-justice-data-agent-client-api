# hmpps-justice-data-agent-client-api

[![Ministry of Justice Repository Compliance Badge](https://github-community.service.justice.gov.uk/repository-standards/api/hmpps-justice-data-agent-client-api/badge?style=flat)](https://github-community.service.justice.gov.uk/repository-standards/hmpps-justice-data-agent-client-api)
[![Docker Repository on ghcr](https://img.shields.io/badge/ghcr.io-repository-2496ED.svg?logo=docker)](https://ghcr.io/ministryofjustice/hmpps-justice-data-agent-client-api)
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://justice-data-agent-client-api-dev.hmpps.service.justice.gov.uk/swagger-ui/index.html)
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-justice-data-agent-client-api/security/policy).
...
## Renaming from HMPPS Justice Data Agent Client Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-justice-data-agent-client-api=0
```
