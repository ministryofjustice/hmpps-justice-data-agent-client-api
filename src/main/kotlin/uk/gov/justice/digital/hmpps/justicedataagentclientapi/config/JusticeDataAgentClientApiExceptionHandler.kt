...
class JusticeDataAgentClientApiExceptionHandler {
  ...
  @ExceptionHandler(SqsQueueException::class)
  fun handleException(e: SqsQueueException): ResponseEntity<ErrorResponse> = ResponseEntity
    .status(INTERNAL_SERVER_ERROR)
    .body(
      ErrorResponse(
        status = INTERNAL_SERVER_ERROR,
